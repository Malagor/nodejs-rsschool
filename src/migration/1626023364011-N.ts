...
export class N1626023364011 implements MigrationInterface {
  name = 'N1626023364011';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "task" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying(50) NOT NULL DEFAULT 'Task', "order" integer NOT NULL DEFAULT '0', "description" character varying NOT NULL DEFAULT '', "userId" uuid, "boardId" uuid, "columnId" character varying, CONSTRAINT "PK_fb213f79ee45060ba925ecd576e" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
